...
<form role="form" method="post" action="" >
                ...
                <br />
            <input type="text" class="form-control" id="kode_krit" name="id_kriteria" value="<?php echo $kode_krit ?>"  size="30" readonly="readonly"/>
              	</div>
               <div class="form-group">
               <label for="kriteria">Kriteria</label>
               <br />
               <input type="text" class="form-control" id="kriteria" name="nama_kriteria" value="<?php echo $nama_krit ?>"/>
               </div>
